...
<body>
            ...
            <div class="box-infos">
                <div class="row" id="box_infos">
                    <div class="box-nifo">
                        ...
                        <div class="box-c">
                            <div class="cont" data-info="brands">
                                5000
                            </div>
           ...
           <div class="form-add-cat">
            <form id="Category">
                <div class="input">
                    ...
                    <div class="value">
                        <input type="text" name="name" id="name" placeholder="Enter Brands Name">
                    </div>
                </div>
                <div class="button">
           ...
           <div class="form-edit-cat">
            <form id="Cate_edit">
                <div class="input">
                    ...
                    <div class="value">
                        <input type="text" name="name" placeholder="Enter Brands Name">
                    </div>
                </div>
                <div class="button">
                    <button type="submit" class="btn-add">
 ...
 <?php include_once base_path() . '/views/layouts/footer.php';?>
    ...
    <script src="../js/admin/_brands.js"></script>
</body>
</html>