        ...
        <div class="body">
           ...
           <div class="form-edit-cat">
            <form id="Cate_edit">
                <div class="input">
                    ...
                    <div class="value">
                        <input type="text" class="Category" name="Category" placeholder="Enter Category Name">
                    </div>
                </div>
                <div class="input">
                    <div class="icon">
                    ...
                    <div class="value">
                        <input type="text" class="Description" name="Description" placeholder="Enter Description ">
                    </div>
                </div>
                <div class="input">
                    <div class="icon">
                ...
                <div class="input">
                   ...
                   <i class="fa-solid fa-tag"></i>
                    ...
                    <div class="value">
                        <input type="text" class="PaymentMethod" name="PaymentMethod" placeholder="Enter PaymentMethod ">
                    </div>
                </div>
                <div class="button">
           ...
           <div class="form-add-cat">
            ...
            <div class="input">
                    ...
                    <div class="value">
                        <input type="date" class="name" name="ExpenseDate" placeholder="Enter ExpenseDate ">
                    </div>
                </div>
            <div class="input">
                    <div class="icon">
                    ...
                    <div class="value">
                        <input type="text" class="name" name="Category" placeholder="Enter Category Name">
                    </div>
                </div>
                <div class="input">
                    <div class="icon">
                    ...
                    <div class="value">
                        <input type="text" class="name" name="Description" placeholder="Enter Description ">
                    </div>
                </div>
                <div class="input">
                    <div class="icon">
                ...
                <div class="input">
                   ...
                   <i class="fa-solid fa-tag"></i>
                    ...
                    <div class="value">
                        <input type="text" class="Price" name="PaymentMethod" placeholder="Enter PaymentMethod ">
                    </div>
                </div>
                <div class="button">
                    <button type="submit" class="btn-add">
